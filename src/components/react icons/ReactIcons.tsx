...
export const FoodAndDrink = ({ progress }:{ progress: number }) => {
    ...
    useEffect(() => {
        ...
        GSAP.to(circleRef.current, {
            ...
            duration: 2, // Adjust the animation duration as needed
            ease: 'Power2.easeOut', // Adjust the easing function as needed
          });
    }, [progress]);
  ...
  return (
    <div className=" relative">
        <svg style={{position:"absolute",top:"0",bottom:"0",left:"0",right:"0",margin:"auto"}} id="progress-border" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 160 160" width="56" height="56">
                    <circle ref={circleRef} fill="none" stroke="#C89104" strokeWidth="6%" strokeDasharray="472" strokeDashoffset={dashOffset} cx="80" cy="80" r="70" strokeLinecap="round" />
         </svg>
...
export const Saving = ({ progress }:{ progress: number }) => {
    ...
    return (
        <div className=" relative">
            <svg style={{position:"absolute",top:"0",bottom:"0",left:"0",right:"0",margin:"auto"}} id="progress-border" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 160 160" width="56" height="56">
                <circle ref={circleRef} fill="none" stroke="#038A39" strokeWidth="6%" strokeDasharray="472" strokeDashoffset={dashOffset} cx="80" cy="80" r="70" strokeLinecap="round" />
            </svg>
...
export const Progress = ({color,progress}:{color: string, progress: number}) => {
    ...
    useEffect(() => {
        ...
        // setDashOffset(calculatedOffset||472);
    ...
    return (
        <svg style={{position:"absolute",top:"0",bottom:"0",left:"0",right:"0",margin:"auto"}} id="progress" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 160 160" width="190" height="190">
            <circle ref={circleRef} fill="none" stroke={color} strokeWidth="6%" strokeDasharray="472" strokeDashoffset={dashOffset} cx="80" cy="80" r="70" strokeLinecap="round" /> 
